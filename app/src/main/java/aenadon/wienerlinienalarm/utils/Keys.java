...
public interface Keys {
    ...
    interface Prefs {
        String FILE_SCHEDULED_ALARMS = "KEY_SCHEDULED_ALARMS";
        String FILE_AUTOINCREMENT_ID = "KEY_AUTOINCREMENT_ID";

        String KEY_AUTOINCREMENT_ID = "NOTIFICATION_AUTOINCREMENT_ID";
    }
